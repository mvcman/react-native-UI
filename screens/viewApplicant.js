        ...
        <View style={styles.content}>
          <View style={{ marginBottom: 10, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <Text style={styles.heading}>
              {route.params.data.item.User.firstName} {route.params.data.item.User.lastName}
            </Text>
            ...
            <View>
              <View style={{ padding: 15, top: '5%', flex: 1, flexDirection: 'row', justifyContent: 'center' }}>
                <TouchableOpacity
                  ...
                  onPress={() => handleAccept(route.params.data.item.applicationId)}
                >
                  <View>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => handleReject(route.params.data.item.applicationId)}
                >
                  <View>
          ...
          {route.params.data.item.status === 'Accepted' ? (
            <View style={{ padding: 15, top: '5%', flex: 1, flexDirection: 'row', justifyContent: 'center' }}>
              <Text style={styles.approved}>This application is already approved</Text>
            </View>
          ) : (
            <View></View>
          )}
          ...
          {route.params.data.item.status === 'Rejected' ? (
            <View style={{ padding: 15, top: '5%', flex: 1, flexDirection: 'row', justifyContent: 'center' }}>
              <Text style={styles.reject}>This application is already rejected</Text>
            </View>
          ) : (
            <View></View>
          )}
